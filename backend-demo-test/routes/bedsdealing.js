...
router.get("/bedsdealingbyusers/:id", bedsdealingController.getBedsdealingByUsersId);

router.get("/bedsdealing", bedsdealingController.getAllBedsdealing);

router.get("/bedsdealingbybeds/:id", bedsdealingController.getBedsdealingByBedsId);
